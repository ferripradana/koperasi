...
@section('dashboard')
   Report Hutang Dagang
@endsection

@section('breadcrumb')
   <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
   <li class="active">Report Hutang Dagang Unit</li>
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Report Hutang Dagang Unit</h3>
              </div>
                <!-- /.box-header -->
                {!! Form::open(['url' => route('hutangdagang.post'), 'method' => 'post', "target"=>"_blank" ]) !!}
                    <div class="box-body">
