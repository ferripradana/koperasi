...
@section('dashboard')
   Report Perhitungan SHU
@endsection

@section('breadcrumb')
   <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
   <li class="active">Report Perhitungan SHU</li>
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Report Perhitungan SHU</h3>
              </div>
                <!-- /.box-header -->
                {!! Form::open(['url' => route('perhitunganshu.post'), 'method' => 'post', "target"=>"_blank" ]) !!}
                    <div class="box-body">
