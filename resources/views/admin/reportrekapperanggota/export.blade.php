...
@section('dashboard')
   Report Rekap Per Anggota
@endsection

@section('breadcrumb')
   <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
   <li class="active">Report Rekap Per Anggota</li>
@endsection
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Report Rekap Per Anggota</h3>
              </div>
                <!-- /.box-header -->
                {!! Form::open(['url' => route('rekapperanggota.post'), 'method' => 'post', "target"=>"_blank" ]) !!}
                    <div class="box-body">
