...
@section('breadcrumb')
   ...
   <li class="active">Report Laba Rugi</li>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                {!! Form::open(['url' => route('labarugi.post'), 'method' => 'post', "target"=>"_blank" ]) !!}
                    <div class="box-body">
                        ...
                        <div class="form-grouphas-feedback{!! $errors->has('bulan') ? 'has-error' : '' !!}">
                            {!! Form::label('bulan_to', 'Bulan Akhir') !!}
                        ...
                        <div class="form-group has-feedback{!! $errors->has('tahun') ? 'has-error' : '' !!}">
                            {!! Form::label('tahun_to', 'Tahun Akhir') !!}
