...
@section('dashboard')
   Laporan Perbandingan Neraca Unit
@endsection

@section('breadcrumb')
   <li><a href="{{ url('home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
   <li class="active">Laporan Perbandingan Neraca Unit</li>
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Report Perbandingan Neraca Unit</h3>
              </div>
                <!-- /.box-header -->
                {!! Form::open(['url' => route('perbneracaunit.post'), 'method' => 'post', "target"=>"_blank" ]) !!}
                    <div class="box-body">
